...
import './App.css'
const ScreenClickDetector = ({ onScreenClick }) => {
  useEffect(() => {
...
const ArrowKeyDetector = ({ onArrowKey }) => {
  useEffect(() => {
...
export default function App() {
  ...
  const [currentClicks, setClicks] = useState(0);
  const proof = ["./src/assets/oldsexual2.jpeg", "/src/assets/oldsexual3.jpeg", "/src/assets/oldsexual4.jpeg", "/src/assets/oldsexual5.jpeg"];
  const slidesData = [
    { 
    ...
    },
    {
      ...
      image: "./src/assets/oldsexual.jpeg",
      clicks: 1
    },
    {
      clicks: 1
    ...
    },
    {
      ...
      image: "./src/assets/sincerely.jpeg",
      clicks: 1
    }, 
    {
    ...
    },
    {
      ...
      clicks: 1,
      image: "./src/assets/elise.jpeg"
    }, 
    {
      header: "On A Serious Note",
      clicks: 1,
      image: "./src/assets/deaths.png"
    },
    {
      ...
      clicks: 1,
      image: "./src/assets/deadman.jpeg"
    }
  ];
  function handleClick() {
    if (slide != slidesData.length-1) {
      setClicks(currentClicks+1);
      if (currentClicks == slidesData[slide].clicks-1) {
        setSlide(slide+1);
        setClicks(0);
      }
    }
  ...
  return (
    <>
    <ScreenClickDetector onScreenClick={handleClick} />
    <ArrowKeyDetector onArrowKey={(direction) => (direction == "right" && slide != slidesData.length-1) ? handleClick() : (slide != 0 ? reverse() : null)} />
      <section className="slide" onClick={handleClick} >
        {(slide == 1 || slide == 13) ? <audio ref={audioRef} autoPlay>{(slide == 1 ? <source src="./src/assets/hi.mp3" type="audio/mpeg" /> : <source src="./src/assets/sincerelyme.mp3" type="audio/mpeg" />)}</audio> : null}
        {slide % 2 == 1 ? <img src={slidesData[slide].image}></img> : null}
        {slide != 4 ? 
          <div>
            <h1>{slidesData[slide].header}</h1>
            <h3>{slidesData[slide].subtitle}</h3>
            <p>{slidesData[slide].credits}</p>
            <p>{(slide == 10 || (currentClicks == 1 && (slide == 1 || slide == 5)))? slidesData[slide].excess : null}</p>
          </div>
        : null}
        {(slide % 2 == 0 && slide !=  4)? <img src={slidesData[slide].image} className={(slide == 0 || slide == 12) ? "spin" : null}></img> : null}
        {slide == 4 ? 
          <>
            <h1>Rui in Denial</h1>
            <div className="proof">
